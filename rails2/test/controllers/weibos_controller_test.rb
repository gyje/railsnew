...
class WeibosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weibo" do
    assert_difference('Weibo.count') do
      post weibos_url, params: { weibo: { neirong: @weibo.neirong, yonghuid: @weibo.yonghuid } }
    end
  ...
  test "should update weibo" do
    patch weibo_url(@weibo), params: { weibo: { neirong: @weibo.neirong, yonghuid: @weibo.yonghuid } }
